...
var speech_edit = {
    ...
    eventBind:function(){
        $(".wrap_speech_edit .save").click( function(){
            var btn_target = $(this);
            ...
            var title_target = $(".wrap_speech_edit input[name=title]");
            var title= title_target.val();

            var address_target = $(".wrap_speech_edit input[name=address]");
            var address= address_target.val();

            var teacher_target = $(".wrap_speech_edit input[name=teacher]");
            var teacher= teacher_target.val();

            var email_target = $(".wrap_speech_edit input[name=email]");
            var email= email_target.val();

            var time_target = $(".wrap_speech_edit input[name=time]");
            var time= time_target.val();


            var speech_intro_target = $(".wrap_speech_edit textarea[name=speech_intro]");
            var speech_intro= speech_intro_target.val();

            var teacher_intro_target = $(".wrap_speech_edit textarea[name=teacher_intro]");
            var teacher_intro= teacher_intro_target.val();

            var id = $(".wrap_speech_edit input[name=id]").val();
           ...
           //参数有效性判断
            ...
            $.ajax({
                url:common_ops.buildUrl("/dong_tai/speech_edit"),
                type:'POST',
                data:data,
                dataType:'json',
