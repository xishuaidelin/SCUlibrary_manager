...
vjs.Slider.prototype.update = function(){
  ...
  // If there is a handle, we need to dongtai for the handle in our calculation for progress bar
  ...
  if (handle) {
    ...
    // The bar does reach the left side, so we need to dongtai for this in the bar's width
